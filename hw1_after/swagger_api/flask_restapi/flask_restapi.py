...
import flask
from flask_restx import reqparse, Resource, Api, fields
from swagger_api.main_models.main_models import models_storege, available_models
from swagger_api.main_models.main_models import fit_model, get_preds, get_params, delete_model
import numpy as np
import pandas as pd
...
fit_parser.add_argument('data_with_target_path',
                          ...
                          required=True,
                          help='Data path',
                          location="args") #'swagger_api/data_sample/data_regression.csv' || 'swagger_api/data_sample/data_classification.csv'

# fit_fields = api.model('Fit body', {
#     'model_class': fields.String(enum=['Regression', 'Classification'], description='Name of a class model'),
#     'model_name': fields.String(default = 'Regression_num_1', description='Custom name of a model'),
#     'params': fields.Raw(description='Model params', required=False),
#     'data_with_target_path' : fields.String(default = 'swagger_api/data_sample/data_regression.csv', description='Data path')
# })
